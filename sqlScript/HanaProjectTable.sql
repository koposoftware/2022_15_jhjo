...
CREATE TABLE CUSTOMER_CARD_INFO(
    ...
    MEMBER_NUM NUMBER(10) DEFAULT CARD_SEQUENCE_NUM.NEXTVAL PRIMARY KEY,
    CARD_CATE_NUM VARCHAR2(30) NOT NULL,
    CARD_PWD VARCHAR2(10) NOT NULL,
    VALID_DATE VARCHAR2(30) NOT NULL,
    CVC_NUM VARCHAR2(10) NOT NULL,
    CARD_RES_DUE VARCHAR2(30) NOT NULL
);

CREATE TABLE CARD_INFO(
    CARD_SEG_NUM VARCHAR2(20) PRIMARY KEY,
    CARD_NAME VARCHAR2(120) NOT NULL,
    ANNUAL_FEE_CODE VARCHAR2(10) NOT NULL,
    CARD_CATE_NUM VARCHAR(20) NOT NULL,
    ANNUAL_FEE NUMBER(20) NOT NULL,
    SORT_CARD VARCHAR2(30) NOT NULL
);
...
CREATE TABLE CARD_BENE(
    ...
    BENE_TYPE VARCHAR2(20) NOT NULL,
    BENE_LIMIT NUMBER(10) NOT NULL,
    BASE_PERFORM NUMBER(8) NOT NULL,
    BENE_RATE NUMBER(5,3) NOT NULL,
